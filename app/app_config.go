...
import (
	...
	_ "github.com/node101-io/pulsar-chain/x/voteexthandler/module"
	voteexthandlermoduletypes "github.com/node101-io/pulsar-chain/x/voteexthandler/types"
		...
		Modules: []*appv1alpha1.ModuleConfig{
			{
				...
				Config: appconfig.WrapAny(&runtimev1alpha1.Module{
					...
					BeginBlockers: []string{
						...
						voteexthandlermoduletypes.ModuleName,
			...
			{
				Name:   voteexthandlermoduletypes.ModuleName,
				Config: appconfig.WrapAny(&voteexthandlermoduletypes.Module{}),
			},
