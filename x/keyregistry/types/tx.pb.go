...
type MsgRegisterKeys struct {
	...
	CosmosAddress   []byte `protobuf:"bytes,4,opt,name=cosmos_address,json=cosmosAddress,proto3" json:"cosmos_address,omitempty"`
	MinaAddress     []byte `protobuf:"bytes,5,opt,name=mina_address,json=minaAddress,proto3" json:"mina_address,omitempty"`
	IsUser          bool   `protobuf:"varint,6,opt,name=is_user,json=isUser,proto3" json:"is_user,omitempty"`
}
...
func (m *MsgRegisterKeys) GetCosmosAddress() []byte {
	if m != nil {
...
func (m *MsgRegisterKeys) GetMinaAddress() []byte {
	if m != nil {
		return m.MinaAddress
	}
	return nil
}

func (m *MsgRegisterKeys) GetIsUser() bool {
	if m != nil {
		return m.IsUser
	}
	return false
...
type MsgUpdateKeys struct {
	...
	UpdateType        KeyUpdateType `protobuf:"varint,6,opt,name=update_type,json=updateType,proto3,enum=pulsarchain.keyregistry.v1.KeyUpdateType" json:"update_type,omitempty"`
}
...
func (m *MsgUpdateKeys) GetUpdateType() KeyUpdateType {
	if m != nil {
		return m.UpdateType
	}
	return KeyUpdateType_USER
}
...
var fileDescriptor_235f5fb22cc1f8d8 = []byte{
	...
	,
}
...
func (m *MsgRegisterKeys) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MinaAddress) > 0 {
		i -= len(m.MinaAddress)
		copy(dAtA[i:], m.MinaAddress)
		i = encodeVarintTx(dAtA, i, uint64(len(m.MinaAddress)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *MsgUpdateKeys) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.UpdateType != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.UpdateType))
		i--
		dAtA[i] = 0x30
	}
...
func (m *MsgRegisterKeys) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.CosmosAddress = append(m.CosmosAddress[:0], dAtA[iNdEx:postIndex]...)
			if m.CosmosAddress == nil {
				m.CosmosAddress = []byte{}
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinaAddress", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MinaAddress = append(m.MinaAddress[:0], dAtA[iNdEx:postIndex]...)
			if m.MinaAddress == nil {
				m.MinaAddress = []byte{}
			}
			iNdEx = postIndex
		case 6:
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UpdateType |= KeyUpdateType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
