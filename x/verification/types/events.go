...
const (
	...
	AttributeKeyValidVotingPower     = "valid_voting_power"
	AttributeKeyInvalidVotingPower   = "invalid_voting_power"
	AttributeKeyTotalVotingPower     = "total_voting_power"
	AttributeKeyVotingPowerThreshold = "voting_power_threshold"
)
