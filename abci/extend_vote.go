...
func (h *VoteExtHandler) ExtendVoteHandler() sdk.ExtendVoteHandler {
	return func(ctx sdk.Context, req *abci.RequestExtendVote) (*abci.ResponseExtendVote, error) {
		...
		if err != nil {
			return nil, errors.Wrap(types.ErrFailedToComputeInitialValidatorSetRoot, err.Error())
		}
		...
		if len(validatorUpdates) != 0 {
			...
			if err != nil {
				return nil, errors.Wrap(types.ErrFailedToApplyValidatorUpdates, "ExtendVoteHandler"+err.Error())
			}

			newValSetRoot, err := h.computeValidatorSetMerkleRoot(newValidatorSet, poseidonHash)
			if err != nil {
				return nil, errors.Wrap(types.ErrFailedToComputeNewSetRoot, err.Error())
			}
		...
		if err != nil {
			return nil, errors.Wrap(types.ErrFailedToSign, err.Error())
		}

		sigBytes, err := signature.MarshalBytes()
		if err != nil {
			return nil, errors.Wrap(types.ErrFailedToMarshal, "signature")
		}
